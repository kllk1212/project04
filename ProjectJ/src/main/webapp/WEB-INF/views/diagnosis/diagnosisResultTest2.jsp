...
<%@ include file="../includes/header.jsp" %>
                        ...
                        <div class="tab_cont pt-A pb-A">
                            ...
                            <div class="tab_chart center-m">
                                <div class="tab_chart_inwrap fx fdc">
                                    ...
                                    <ul class="category_num">
                                        <li>
                                            ...
                                            <c:set var="avg" value="${cDTO.c_tAvgSales/100}" /><!--노출되지않음 소수점버림  -->
                                            <!--  <span style="font-size: 15pt">${comName }</span></br>-->
                                ...
                                <div class="category_list">
                                    ...
                                    <div>
                                        <!-- <p>${areaName}지역의 ${cDTO.c_type } 업종 프랜차이즈 평균 매출<p> -->
                                        <p>${ areaName} 지역의 ${cDTO.c_type } 업종 프랜차이즈 평균 매출<p>
                                    </div>
                                    <div>
                                ...
                                <div class="fx jsb">
                                    <div class="tab_inwrap">
                                        <table>
                                            <!-- <tr>
                                                <th>가맹 총부담금</th>
                                                <td>${cDTO.c_totalFee*1000}원 </td>
                                            </tr>
                                            <tr>
                                                <th>평균 매출액</th>
                                                <td>${cDTO.c_tAvgSales*100}원 </td>
                                            </tr>
                                            <tr>
                                                <th>1평당 평균매출액</th>
                                                <td>${cDTO.c_tSquareSales*100}원 </td>
                                            </tr>-->
                                            <tr>
                                                <th>가맹 총부담금</th>
                                                <td>${cDTO.c_totalFee*1000}원</td>
    ...
    <script>
        $(function(){
            ...
            /// =======================================  ///
            // 가맹현황 테이블에 있는 값 콤마 찍기 / 화폐 단위 자동 추가
            /// =======================================  ///
